...
### Simulation to Estimate Sample Variability
...
3. Repeat steps 2 and 3 many (say 10,000) times, keeping track of the mean mercury concentrations in each bootstrap sample. 
...
Lakes_Bootstrap_Mean  + geom_segment(x = q.025, y = 0,
               xend = q.975, yend = 0,
               color = "black",
               size=5,
...
Lakes_Bootstrap_SD   + geom_segment(x = q.025, y = 0,
               xend = q.975, yend = 0,
               color = "black",
               size=5,
               arrow = arrow(ends="both"))
...
Lakes_Bootstrap_PropOver1 + geom_segment(x = q.025, y = 0,
               xend = q.975, yend = 0,
               color = "black",
               size=5,
               arrow = arrow(ends="both"))
...
Lakes_Bootstrap_Median <- ggplot(data=Lakes_Bootstrap_Results_Other, aes(x=MedianHg)) + geom_histogram(fill="lightblue")+
  ...
  ggtitle("Bootstrap Distribution for Sample Median in Florida Lakes") + geom_segment(x = q.025, y = 0,
               xend = q.975, yend = 0,
               color = "black",
               size=5,
               arrow = arrow(ends="both"))
...
NS_Lakes_Bootstrap_Plot_b1 + geom_segment(x = q.025, y = 0,
               xend = q.975, yend = 0,
               color = "black",
               size=5,
               arrow = arrow(ends="both"))
...
Cars_Acc060_B_Slope_Plot +   geom_segment(x = q.025, y = 0,
               xend = q.975, yend = 0,
               color = "black",
               size=5,
               arrow = arrow(ends="both"))
...
Bears_plot_b1 +    geom_segment(x = q.025, y = 0,
               xend = q.975, yend = 0,
               color = "black",
               size=5,
               arrow = arrow(ends="both"))
...
ggplot(data=Bears_Bootstrap_Results, aes(x=b1+b3, fill=!(b1+b3 >=q.975 | b1 + b3 <= q.025))) +  geom_histogram(color="white", fill="lightblue") + 
  ...
  ggtitle("Bears Weight by Age and Sex:Bootstrap Distribution for b1+b3") + geom_segment(x = q.025, y = 0,
               xend = q.975, yend = 0,
               color = "black",
               size=5,
               arrow = arrow(ends="both")) 
...
ggplot(data=Bears_Bootstrap_Results, aes(x=b0+24*b1)) +  
  ...
  ylab("Frequency") +
  ggtitle("Bears Weight by Age and Sex: Bootstrap Distribution for b0+24b1")  + geom_segment(x = q.025, y = 0,
               xend = q.975, yend = 0,
               color = "black",
               size=5,
               arrow = arrow(ends="both")) 
...
ggplot(data=Bears_Bootstrap_Results, aes(x=(b0+b2)+24*(b1+b3))) +  
  ...
  ylab("Frequency") +
  ggtitle("Bears Weight by Age and Sex: Bootstrap Distribution for (b0+b2)+24*(b1+b3)")  + geom_segment(x = q.025, y = 0,
               xend = q.975, yend = 0,
               color = "black",
               size=5,
               arrow = arrow(ends="both"))
...
```{r, fig.height=2, fig.width=7}
Lakes_Bootstrap_Mean  + geom_segment(x = q.025, y = 0, xend = q.975, 
                                     yend = 0,color = "black",size=5,
                                     arrow = arrow(ends="both")) + geom_segment(x = -2*SE, y = 100, xend = +2*SE, 
                                     yend = 100,color = "yellow",size=5,
                                     arrow = arrow(ends="both"))
```
Percentile interval in black, standard error interval in yellow. 
...
```{r, fig.height=2, fig.width=7}
NS_Lakes_Bootstrap_Plot_b1  + geom_segment(x = q.025, y = 0, xend = q.975, 
                                     yend = 0,color = "black",size=5,
                                     arrow = arrow(ends="both")) + geom_segment(x = -2*SE, y = 100, xend = +2*SE, 
                                     yend = 100,color = "yellow",size=5,
                                     arrow = arrow(ends="both"))
...
```{r, fig.height=2, fig.width=7}
Cars_Acc060_B_Slope_Plot  + geom_segment(x = q.025, y = 0, xend = q.975, 
                                     yend = 0,color = "black",size=5,
                                     arrow = arrow(ends="both")) + geom_segment(x = Stat-2*SE, y = 100, xend = Stat+2*SE, 
                                     yend = 100,color = "yellow",size=5,
                                     arrow = arrow(ends="both"))
```
Percentile interval in black, standard error interval in yellow. 
...
```{r, fig.height=2, fig.width=7}
Lakes_Bootstrap_PropOver1  + geom_segment(x = q.025, y = 0, xend = q.975, 
                                     yend = 0,color = "black",size=5,
                                     arrow = arrow(ends="both")) + geom_segment(x = Stat-2*SE, y = 100, xend = Stat+2*SE, 
                                     yend = 100,color = "yellow",size=5,
                                     arrow = arrow(ends="both"))
...
```{r, fig.height=2, fig.width=7}
Bears_plot_b1 +xlim(c(1.5,6.5)) + geom_segment(x = q.025, y = 0, xend = q.975, 
                                     yend = 0,color = "black",size=5,
                                     arrow = arrow(ends="both")) + geom_segment(x = Stat-2*SE, y = 100, xend = Stat+2*SE, 
                                     yend = 100,color = "yellow",size=5,
                                     arrow = arrow(ends="both"))
