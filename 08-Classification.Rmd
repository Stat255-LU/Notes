...
6. Define specificity and sensitivity, and calculate them for given data.   
7. Explain the information contained in a receiver operating characteristic (ROC) curve.   
8. Construct receiver operating curves for small sets of data.   
9. Compare classifiers using misclassification rate, and AUC.  
