...
```{r}
AOV_condition <- aov(data=Houses, price~condition)
summary(AOV_condition)
```

* The *condition* line represents the variability in average price between different conditions    
* The *Residuals* line represents the variability between individual houses within each condition   
