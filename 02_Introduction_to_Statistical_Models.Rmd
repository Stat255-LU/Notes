...
ggplot(data=Houses, aes(x=Neighborhood, y=SalePrice)) +geom_point() + 
  stat_summary(fun.y = mean, geom = "errorbar", aes(ymax = ..y.., ymin = ..y..),
                 width = 0.75, linetype = "solid", color="red") + theme_bw() + ggtitle("Houses by Neighborhood")
```
...
We call the sum of squared residuals for the model with no explanatory variables the total sum of squares, abbreviated SST.   
...
### Bears Int. Model Interpretations
...
For each additional inch in length, the weight of a 6-month old bear is expected to increase by $5.624+6(0.126)=6.38$ pounds. 

For each additional inch in length, the weight of a 6-month old bear is expected to increase by $5.624+24(0.126)=8.65$ pounds. 
